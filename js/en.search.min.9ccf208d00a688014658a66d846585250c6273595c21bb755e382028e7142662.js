...
input.addEventListener('focus',init);input.addEventListener('keyup',search);function init(){input.removeEventListener('focus',init);loadScript('/Nihamawassa/heartland/js/groupBy-62b30ac391.min.js');loadScript('/Nihamawassa/heartland/js/flexsearch-ad47a5e1ee.min.js',function(){const indexCfg={};const dataUrl="/Nihamawassa/heartland/en.search-data.min.json"
